          ...
          <div className="col-lg-12 col-md-12">
            <div className="row">
              <div className="col-lg-3 col-md-6">
                <div className="card mb-4">
                  <div className="card-title card-body mb-0 pb-0">
                    <h3 className="mb-4">Ganancias del mes</h3>
                    <p className="text-primary mb-0 text-24">S/ 123.00</p>
                  </div>
              ...
              <div className="col-lg-3 col-md-6">
                <div className="card mb-4">
                  <div className="card-title card-body mb-0 pb-0">
                    <h3 className="mb-4">Cantidad total</h3>
                    <p className="text-primary mb-0 text-24">S/ 230.00</p>
                  </div>
          ...
          <div className="col-md-12">
            <div className="card mb-4">
              <div className="card-body card-title mb-0">
                <h3 className="m-0">Balance del mes</h3>
              </div>
